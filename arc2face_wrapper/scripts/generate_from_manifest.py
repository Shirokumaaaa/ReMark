...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--manifest", type=str, required=True, help="CSV with source/expression/reference columns.")
...
def main() -> None:
    ...
    generator = Arc2FaceExpressionGenerator(models_dir="models", strict_cuda_provider=strict_cuda)
