...
2) Update config
- Edit `config/generate_config.json` and set:
...
/home/ldy/miniconda3/envs/arc2face/bin/python scripts/generate_example.py
```

## Configuration Reference

File: `config/generate_config.json`
...
- If you move this folder to a new machine or project, you only need to update paths in `config/generate_config.json`.
