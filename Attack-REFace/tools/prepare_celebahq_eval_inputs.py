...
def main():
    ...
    parser.add_argument("--faceswap-input-dir",type=Path,default=repo_root / "data" / "faceswap_inputs")
    ...
    materialize_links(source_paths, args.faceswap_input_dir / "source")
    materialize_links(target_paths, args.faceswap_input_dir / "target")

    print(f"dataset_root={dataset_root}")
    print(f"source_count={len(source_paths)} csv={source_csv}")
    print(f"target_count={len(target_paths)} csv={target_csv}")
    print(f"source_links_dir={args.faceswap_input_dir / 'source'}")
    print(f"target_links_dir={args.faceswap_input_dir / 'target'}")
