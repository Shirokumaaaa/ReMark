...
from network.ldm.modules.diffusionmodules.model import Encoder, Decoder
from network.ldm.modules.distributions.distributions import DiagonalGaussianDistribution
from network.ldm.util import instantiate_from_config
from network.ldm.modules.attention import LinearAttention
import lpips
...
class VQModel(pl.LightningModule):
    def __init__(self,
        ...
        self.perc = lpips.LPIPS(net="alex")
    def forward(self, input):
        quant = self.encoder(input)
