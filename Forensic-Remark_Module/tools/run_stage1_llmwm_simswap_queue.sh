...
LOG_FILE="${LOG_DIR}/llmwm_simswap_queue_${STAMP}.log"
...
run_one "configs/experiments/stage1_sleepermark_celebahq_simswap_llmwm.yaml" "sleepermark"
run_one "configs/experiments/stage1_tagwm_celebahq_simswap_llmwm.yaml" "tagwm"
run_one "configs/experiments/stage1_lawa_celebahq_simswap_llmwm.yaml" "lawa"

echo "[$(date '+%F %T')] ALL_DONE llmwm_simswap_queue" | tee -a "${LOG_FILE}"
echo "${LOG_FILE}"
