...
OVERRIDES=(
  "configs/experiments/stage1_sepmark_ffhq_diffswap_replay.yaml"
  "configs/experiments/stage1_lampmark_ffhq_diffswap_replay.yaml"
  "configs/experiments/stage1_trustmask_ffhq_diffswap_replay.yaml"
  "configs/experiments/stage1_maskwm_ffhq_diffswap_replay.yaml"
  "configs/experiments/stage1_fin_ffhq_diffswap_replay.yaml"
)
...
echo "[$(date '+%F %T')] ALL DONE (5 WM models with DiffSwap replay)."
