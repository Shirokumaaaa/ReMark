...
OVERRIDES=(
  "configs/experiments/stage1_sepmark_ffhq_arc2face.yaml"
  "configs/experiments/stage1_lampmark_ffhq_arc2face.yaml"
  "configs/experiments/stage1_trustmask_ffhq_arc2face.yaml"
  "configs/experiments/stage1_maskwm_ffhq_arc2face.yaml"
  "configs/experiments/stage1_fin_ffhq_arc2face.yaml"
)
...
echo "[$(date '+%F %T')] ALL DONE (5 WM models with arc2face)."
