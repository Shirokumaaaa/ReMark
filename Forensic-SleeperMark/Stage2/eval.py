...
parser.add_argument('--num_samples', type=int, default=10, help='Number of prompts to evaluate')
...
with torch.no_grad():
    eval_prompts = prompts[:args.num_samples]
    for i, prompt in enumerate(tqdm.tqdm(eval_prompts)):
